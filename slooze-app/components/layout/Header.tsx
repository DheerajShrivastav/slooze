    ...
    <header className="sticky top-0 z-50 w-full border-b bg-background/95 backdrop-blur supports-[backdrop-filter]:bg-background/60">
      <div className="container flex h-16 items-center justify-between">
        <div className="flex items-center gap-6">
          <Link href="/" className="flex items-center gap-2">
            ...
            <span className="text-xl font-bold tracking-tight text-foreground">Slooze</span>
          </Link>
      ...
      {isMenuOpen && (
        <div className="md:hidden border-t bg-background p-4 space-y-4">
            <Link href="/restaurants" className="block text-sm font-medium hover:text-primary">Restaurants</Link>
            <Link href="/offers" className="block text-sm font-medium hover:text-primary">Offers</Link>
            {isAuthenticated && (
               <Link href="/orders" className="block text-sm font-medium hover:text-primary">My Orders</Link>
            )}
            {isAdminOrManager && (
               <Link href="/admin" className="block text-sm font-medium hover:text-primary flex items-center gap-1">
                 <LayoutDashboard size={14} />
                 Dashboard
               </Link>
            )}
